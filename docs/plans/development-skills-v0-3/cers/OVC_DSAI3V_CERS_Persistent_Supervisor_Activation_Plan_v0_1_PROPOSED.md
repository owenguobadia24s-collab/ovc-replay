# OVC DSAI3V CERS Persistent Supervisor Activation Plan v0.1 — PROPOSED

**Plan ID:** `OVC-DSAI3V-CERS-PERSISTENT-SUPERVISOR-ACTIVATION-PLAN-0.1-PROPOSED`  
...
**Proposal baseline:** `main@57995c54e2963984776832b7522841e6b7c834b0` / tree `f67c49b8c3422948bfd96e1e2f7de3f1e19459a8`  
**Status:** PROPOSED — NOT RATIFIED — NO RUNTIME AUTHORITY  
**Authority effect:** NONE. This artifact proposes a bounded successor implementation/activation programme; it does not activate CERS, change quiescence, admit a programme, or grant writer/merge/scientific authority.
...
## 2. Proposed authority envelope before activation

If this plan is ratified, the following implementation work is AUTO-EXECUTABLE before the activation gate:
...
Until operator ratification of this plan, no packet in this proposal is executable and general CERS dispatch remains disabled.
