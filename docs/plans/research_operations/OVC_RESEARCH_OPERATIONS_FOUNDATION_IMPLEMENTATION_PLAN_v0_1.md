...
It does not authorise provider access, aggregation, market-release construction, mutation of OPT-A or OPT-B records, R2 publication, selector or threshold changes, validation-payload access, probability, setup, exposure, risk, execution objects, agent tools, autonomous mutation or direct writes to `main`.
...
- Parallel model state: OPT-B.C1 v2 WP2 passed; WP3 reference-engine work authorised on synthetic and golden fixtures only
