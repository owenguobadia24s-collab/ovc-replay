# IROF-WP9 Golden Synthetic Full-Chain Implementation Receipt
...
WP9 adds one compact synthetic golden population and a reusable golden integration harness that exercises the furthest currently lawful descriptive evidence surface without invoking any reserved real-run authority.

The golden population covers ordinary observations, explicit gap/missing-parent fixture cases, NOT_EVALUABLE population exclusion, state-transition and cross-scale cases, C2E lifecycle vocabulary (birth, continuation, mutation, censoring, split, merge, re-parent and conflict), SRI raw/normalized representation, comparability admission/rejection, exact/tolerance comparison, family/member/singleton/zero-family/ambiguous outcomes, non-structural OccurrenceContext projection, semantic-cache reuse/corruption, checkpoint/restart and scheduling-order permutations.
...
`LOCAL_SYNTHETIC_EXECUTION_ONLY` / `NONE` scientific authority effect.
...
Remove the golden fixture, harness, tests and compact WP9 receipts. No source-stage output, selector, active pack, Research Operations evidence or scientific state requires rewriting.
