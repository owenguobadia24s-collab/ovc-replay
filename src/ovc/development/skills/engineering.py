...
def build_artifact_proposal(*, kind: str, logical_path: str, payload: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema": "ovc-dsai-artifact-proposal/v1", **logical,
        "proposal_id": canonical_sha256(logical, role="DSAI_ARTIFACT_PROPOSAL"),
        "execution_mode": "DRY_RUN", "authority_effect": "NONE", "writes_performed": [],
    }
...
def classify_head_churn(**kwargs: Any) -> dict[str, Any]:
    """Thin wrapper preserving the shared head-churn service as the single implementation."""
