"""Laboratory Scientific Inheritance & Accession research-governance helpers.
...
GEN0002 carries the exact corrected frontier accounting into a deterministic Pass-1
source-standing/exposure/dependence classification only; no survival or inheritance
role is produced here.
"""
