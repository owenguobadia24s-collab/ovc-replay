...
GEN0002 frontier accounting only remains the historical repair boundary; the current
packet additionally performs deterministic Pass-1 source-state classification. Both fail
closed on identity drift and neither grants Pass-2 or scientific accession authority.
"""
