...
def _validate_registry_bundle(registries: Mapping[str, Any]) -> None:
    ...
    for registry_name, registry in registries.items():
        ...
        _require(registry.get("status") in {"FROZEN_ATLAS_G1", "SKELETON_ATLAS_G1", "FROZEN_ATLAS_G3", "IMPLEMENTED_PENDING_ATLAS_G4_ALG"}, f"ATLAS_REGISTRY_STATUS:{registry_name}")
