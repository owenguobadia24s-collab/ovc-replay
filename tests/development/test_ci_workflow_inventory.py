...
EXPECTED_SNAPSHOTS = {
    "0_11": (191, 141, 50), "0_10": (191, 140, 51), "0_9": (191, 139, 52),
    "0_8": (191, 138, 53), "0_7": (191, 137, 54), "0_6": (191, 136, 55),
    "0_5": (191, 135, 56), "0_4": (191, 134, 57), "0_3": (191, 133, 58),
    "0_2": (177, 131, 46), "0_1": (175, 129, 46),
}
EXPECTED_SUPERSESSION_CHAIN = {
    "0_11":"OVC.CIPR.WORKFLOW_GOVERNANCE.v0.10", "0_10":"OVC.CIPR.WORKFLOW_GOVERNANCE.v0.9",
    "0_9":"OVC.CIPR.WORKFLOW_GOVERNANCE.v0.8", "0_8":"OVC.CIPR.WORKFLOW_GOVERNANCE.v0.7",
    "0_7":"OVC.CIPR.WORKFLOW_GOVERNANCE.v0.6", "0_6":"OVC.CIPR.WORKFLOW_GOVERNANCE.v0.5",
    "0_5":"OVC.CIPR.WORKFLOW_GOVERNANCE.v0.4", "0_4":"OVC.CIPR.WORKFLOW_GOVERNANCE.v0.3",
...
class CiWorkflowInventoryGovernanceTests(unittest.TestCase):
    ...
    def test_current_inventory_is_exhaustive_and_exact(self):
        ...
        self.assertEqual(self.inventory["total_workflow_definitions"], 141)
        self.assertEqual(sum(self.inventory["category_counts"].values()), 141)
    ...
    def test_greal_is_push_only_and_exactly_bounded(self):
        admission = self.policy["admitted_new_workflow"]
        path = ".github/workflows/c2p2-sd-greal.yml"
        ...
        for marker in ("ONE_EXACT_FULL_POPULATION", "DISAGREEMENT_EVIDENCE_ONLY", "NO_SELECTION", "NO_ACTIVATION", "NO_VALIDATION", "NO_PUBLICATION", "NO_EC1_CANDIDATE_USE"):
            self.assertIn(marker, admission["authority_mode"])

    def test_prior_sd_and_r5_workflows_are_preserved_non_pr(self):
        admissions = {row["path"]:row for row in self.policy["additional_non_pr_diagnostic_workflows"]}
        for path in (".github/workflows/c2p2-sd-wp3-qualification-r2.yml", ".github/workflows/c2p2-sd-wp3-qualification.yml", ".github/workflows/c2p2-rs0-real-source-shadow-run-r5.yml"):
