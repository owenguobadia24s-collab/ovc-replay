...
POLICY_PATH = ROOT / "registries/development/OVC_CI_WORKFLOW_GOVERNANCE_POLICY_v0_3.json"
HISTORICAL_POLICY_PATH = ROOT / "registries/development/OVC_CI_WORKFLOW_GOVERNANCE_POLICY_v0_2.json"
...
class CiWorkflowInventoryGovernanceTests(unittest.TestCase):
    ...
    def test_actions_registry_and_repository_definition_layers_are_distinct(self):
        ...
        self.assertEqual(snapshot["expected_repository_workflow_definition_count"], 133)
        self.assertEqual(snapshot["registration_count_excess"], 58)
        self.assertEqual(
    ...
    def test_v0_2_snapshot_remains_historical_and_unchanged(self):
        ...
        self.assertEqual(self.historical_policy["policy_id"], "OVC.CIPR.WORKFLOW_GOVERNANCE.v0.2")
