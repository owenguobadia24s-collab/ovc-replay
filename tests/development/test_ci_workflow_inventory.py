...
CURRENT_VERSION = "0_8"
HISTORICAL_VERSIONS = ("0_7", "0_6", "0_5", "0_4", "0_3", "0_2", "0_1")
EXPECTED_SNAPSHOTS = {
    "0_8": (191, 138, 53),
    "0_7": (191, 137, 54),
    "0_6": (191, 136, 55),
...
class CiWorkflowInventoryGovernanceTests(unittest.TestCase):
    ...
    def test_current_and_historical_snapshot_chain_is_preserved(self):
        ...
        self.assertEqual(self.policy["historical_policy_preserved"], "registries/development/OVC_CI_WORKFLOW_GOVERNANCE_POLICY_v0_7.json")
    ...
    def test_r5_workflow_is_operator_bounded_non_pr_single_use(self):
        admission = self.policy["admitted_new_workflow"]
        path = ".github/workflows/c2p2-rs0-real-source-shadow-run-r5.yml"
        ...
        for marker in ("R5_SINGLE_USE_REAL_SOURCE","COMPARATIVE_SHADOW_ONLY","11GIB_EXECUTION_STORAGE_CEILING","NO_SELECTION","NO_ACTIVATION","NO_VALIDATION","NO_PUBLICATION","NO_REQUIRED_CHECK_SUBSTITUTION"):
            self.assertIn(marker, mode)

    def test_r4_recovery_and_other_preserved_workflows_remain_non_pr(self):
