...
def test_cers_wp0_freezes_current_control_plane_without_authority_expansion():
    ...
    assert freeze["observed_main"]["commit"] == "c8e2e610eddf59014644ac61e648ce27ae000f38"
    assert freeze["observed_main"]["tree"] == "4e9d5fe9211976ab606de3f190391f6c4166639b"
...
def test_cers_wp0_authority_manifest_and_dependency_frontier_are_exact():
    ...
    assert _canonical_id(frontier) == packet["dependency_frontier_id"] == "56ad628941caa788842ba1a6fe7b37082ab5215f284486698df01d16b6fbac23"
