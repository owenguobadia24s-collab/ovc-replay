...
def test_cers_wp0_freezes_current_control_plane_without_authority_expansion():
    ...
    assert freeze["observed_main"]["commit"] == "e70f9559fdde65921966b7507c443b195ce4f266"
    assert freeze["observed_main"]["tree"] == "b25a7becccd356ad32a16f7465f791a0e06a93fc"
...
def test_cers_wp0_authority_manifest_and_dependency_frontier_are_exact():
    ...
    assert _canonical_id(frontier) == packet["dependency_frontier_id"] == "6dfffc81b888e136a201917624898f1cc972b2dcb8a648132df17e5d8adfc731"
