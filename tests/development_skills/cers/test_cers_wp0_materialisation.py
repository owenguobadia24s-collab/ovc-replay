...
def test_cers_wp0_freezes_current_control_plane_without_authority_expansion():
    ...
    assert freeze["observed_main"]["commit"] == "c6b5c8ee6ccf89753d7f990584ca4569ba830bf2"
    assert freeze["observed_main"]["tree"] == "2a70b288ae84d247137ffa7ac5d3e7e8784dd487"
...
def test_cers_wp0_authority_manifest_and_dependency_frontier_are_exact():
    ...
    assert _canonical_id(frontier) == packet["dependency_frontier_id"] == "0b7dae108b0d4dbe16d5f8d2ca2bdadd8b5936edf05fc4dcc74e0c5d1ce127dd"
