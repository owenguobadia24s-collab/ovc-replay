...
def test_cers_wp0_freezes_current_control_plane_without_authority_expansion():
    ...
    assert freeze["observed_main"]["commit"] == "a11d29569321e4fe608f09dd51c04349c3f1c13f"
    assert freeze["observed_main"]["tree"] == "9e5cc15ef1e43b51eade229cd262eea1471bce6d"
...
def test_cers_wp0_authority_manifest_and_dependency_frontier_are_exact():
    ...
    assert _canonical_id(frontier) == packet["dependency_frontier_id"] == "63c2c9f614ffb9df2be1c647b49be7ba6514600b5ac34348b772562fcde977f2"
