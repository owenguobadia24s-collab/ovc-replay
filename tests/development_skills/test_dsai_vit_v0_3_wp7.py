...
class DsaiVitV03Wp7Tests(unittest.TestCase):
    def setUp(self) -> None:
        self.events = (
            ...
            HistoricalReplayEvent("e4","dsai-throughput-plan","DSAI","PORTFOLIO","MULTI_LANE_PERIOD"),
    ...
    def test_authority_inference_blocks_q2_completeness(self) -> None:
        ...
        self.assertFalse(require_q2_source_completeness(replay_historical_events(bad),("STALE_MAIN_REQUEUE",)))
