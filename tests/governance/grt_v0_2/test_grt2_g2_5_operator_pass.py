...
class GRT2G25OperatorPassTests(unittest.TestCase):
    ...
    def test_programme_state_preserves_pilot_activation_and_advances_evidence_collection(self) -> None:
        ...
        self.assertEqual(threshold_state["active_enforcement"], "LIMITED_NEW_ARTIFACT_ENFORCEMENT")
