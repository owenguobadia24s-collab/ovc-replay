...
class GRT2G2FinalStateTests(unittest.TestCase):
    ...
    def test_programme_state_preserves_g2_pass_while_current_pointer_advances_to_correction(self) -> None:
        ...
        current_state = json.loads((STATE / "OVC_GRT2_STATE_v0_13.json").read_text(encoding="utf-8"))
        ...
        self.assertEqual(current_state["g3_status"], "NOT_AUTHORISED_CORRECTIVE_IMPLEMENTATION_RUNNING")
