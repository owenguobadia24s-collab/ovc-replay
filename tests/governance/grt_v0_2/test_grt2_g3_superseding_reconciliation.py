...
def test_superseding_reconciliation_is_exact_and_authority_inert() -> None:
    ...
    assert evidence["current_protected_main"] == {"commit": "36701ddbdc4004ab98052d80b78b512d873fb293", "tree": "0a8cbb0891f49073f933e7fa8b711b33a56782d6"}
    ...
    assert evidence["current_census"]["finding_count"] == 1641
...
def test_candidate_floor_seed_is_new_valid_and_inactive() -> None:
    ...
    assert floor["floor_hash"] == "3627f18a2c24db74d6bf4674487c6f1a805ae8282184336fcc0c5d1ddb7b273c"
    assert len(floor["open_grandfathered_findings"]) == 1641
    evidence = load("GRT2_G3_SUPERSEDING_READINESS_RECONCILIATION_EVIDENCE.json")
