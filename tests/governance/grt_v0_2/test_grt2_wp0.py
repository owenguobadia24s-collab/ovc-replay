...
from ovc.programme_genesis.grt_v0_2.wp0 import B0_ANOMALY_COUNT, B0_COMPONENT_COUNT, B0_COMPONENT_EDGE_COUNT, B0_PROGRAMME_COUNT, B0_SOURCE_COMMIT, B0_SOURCE_TREE, B0_TOPOLOGY_SHA256, B0_WARNING_COUNT
...
class GRT2WP0ContractTests(unittest.TestCase):
    ...
    def test_materialised_source_identity_is_exact_and_non_enforcing(self) -> None:
        ...
        self.assertEqual(identity["materialisation_baseline"]["commit"], "4d7d725c0960eb24e1ac137fe912ad8c7cc6f82b")
