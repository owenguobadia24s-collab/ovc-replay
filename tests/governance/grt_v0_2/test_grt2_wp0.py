...
class GRT2WP0ContractTests(unittest.TestCase):
    def test_frozen_b0_source_constants_match_ratified_wp0_contract(self) -> None:
        ...
        self.assertEqual(B0_WARNING_COUNT, 569)
        self.assertEqual(B0_ANOMALY_COUNT, 1364)
        self.assertEqual(B0_PROGRAMME_COUNT, 53)
        self.assertEqual(B0_COMPONENT_COUNT, 4615)
        self.assertEqual(B0_COMPONENT_EDGE_COUNT, 11861)
    ...
    def test_materialised_source_identity_is_exact_and_non_enforcing(self) -> None:
        ...
        self.assertEqual(identity["materialisation_baseline"]["commit"], "a720f4fb3b41c267a6ed40dc9498e8f48004fbf7")
