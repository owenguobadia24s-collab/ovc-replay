...
class ActiveStackReclassificationTests(unittest.TestCase):
    ...
    def test_pointer_resolves_exact_current_state(self) -> None:
        ...
        self.assertEqual(resolved["active_spine"], ["OPT-A", "OPT-B.C1.v2", "OPT-B.C2.vNext", "OPT-B.C2E.v0.2"])
    ...
    def test_operator_decision_is_exact_and_reserved_delta_is_materialised(self) -> None:
        ...
        self.assertEqual(approved["legacy_c2_v2"], "RETIRE_FROM_NEW_EVIDENCE_RUNTIME_AND_CLASSIFY_LEGACY_INACTIVE")
        self.assertEqual(approved["c2_vnext_core"], "ACTIVATE_EXACT_NINE_COMPONENT_CORE_DISCOVERY_AND_DEVELOPMENT")
    ...
    def test_c2_vnext_core_is_active_without_promoting_research_candidates(self) -> None:
        ...
        self.assertEqual(authority["shadow_components"], ["FUNCTIONAL_DISCOVERY", "CANDIDATE_DISPOSITIONS"])
        ...
        self.assertEqual(classification(self.state, "OPT-B.C2.vNext.FUNCTIONAL_DISCOVERY"), "SHADOW")
    ...
    def test_occurrence_context_is_active_foundation_but_not_representation_input(self) -> None:
        ...
        self.assertEqual(classification(self.state, "OCCURRENCE_CONTEXT.v0.1"), "ACTIVE_FOUNDATION")
    ...
    def test_research_operations_is_active_foundation_without_authority_escalation(self) -> None:
        ...
        self.assertEqual(classification(self.state, "RESEARCH_OPERATIONS_FOUNDATION"), "ACTIVE_FOUNDATION")
    ...
    def test_shadow_non_evaluable_legacy_and_locked_classes_are_disjoint(self) -> None:
        ...
        self.assertEqual(classification(self.state, "OPT-B.C2P.v0.2.PERSISTENT_STRUCTURAL_OBJECTS"), "NON_EVALUABLE")
