...
class NativeGenesisPortfolioG3R6Tests(unittest.TestCase):
    ...
    def test_gate_is_ready_without_adoption_or_edge_acceptance(self) -> None:
        ...
        self.assertEqual("OVC APPROVE PGN-G3-R6 ACKNOWLEDGE_CONTINUE", self.gate["exact_operator_command"])
        ...
        self.assertEqual("DENIED_PENDING_R6_ACKNOWLEDGEMENT_AND_SEPARATE_PGN_G3_OPERATOR_DECISIONS", self.state["authority"]["native_adoption"])
