...
AG3_ID = "C2E-AG3.OPERATOR.ACTIVATE_NAMED_PACK.20260811T220500+0100"
...
class C2EAG0R2OperatorPassTests(unittest.TestCase):
    ...
    def test_pass_admits_only_evaluation_and_never_activation_at_ag0(self):
    ...
    def test_state_and_pointer_route_only_through_lawful_ag_progression(self):
        ...
        if self.pointer.get("ag3") == "EXECUTED_PASS_ACTIVATE_NAMED_PACK":
            self.assertEqual(self.pointer["candidate_boundary_pack_status"], "ACTIVE_OPERATOR_SELECTED_NONCANONICAL")
            ...
            self.assertIn(AG3_ID, self.pointer["operator_decision_history"])
