...
class C2EAG1R4PassTests(unittest.TestCase):
    ...
    def test_ag1_pass_only_allows_later_governed_progression(self):
        ...
        if p.get("ag3") == "EXECUTED_PASS_ACTIVATE_NAMED_PACK":
            ...
            self.assertEqual(p["active_boundary_pack"],PACK_ID)
        else:
