...
def test_approval_reuses_gate_bindings_only_after_non_material_main_advance() -> None:
    decision = _read("docs/releases/c2p-persistent-structural-objects-v0-2/c2p2-rs0/C2P2_RS0_GRUN_OPERATOR_DECISION_v0_1.json")
    ...
    assert decision["currentness_review"]["result"] == "PASS_REUSE_GATE_READY_BINDINGS"
    assert decision["currentness_review"]["grun_bound_source_authority_candidate_population_capacity_or_artifact_root_changed"] is False
