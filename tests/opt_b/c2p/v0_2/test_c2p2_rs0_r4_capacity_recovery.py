...
def test_reused_synthetic_workflow_has_no_real_source_download_or_run_authority() -> None:
    workflow = (ROOT / ".github/workflows/c2p2-rs0-semantic-scalability-qualification.yml").read_text()
    assert "recover/c2p2-rs0-run-recovery-r4-20260818" in workflow
