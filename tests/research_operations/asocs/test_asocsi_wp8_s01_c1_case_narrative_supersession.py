...
def test_qa_decision_state_preserves_historical_human_input_boundary_after_forward_supersession():
    ...
    if current['packet_id']==STAGE2_PREP:
        ...
        assert ptr['current_state'].endswith('ASOCSI_PROGRAMME_STATE_v0_30_WP8_S01_STAGE2_C2_PRIMITIVE_STRUCTURE_HUMAN_ADJUDICATION_GATE_READY.json')
        ...
        assert current['next_packet']=='ASOCSI-WP8-S01-STAGE2-C2-NATIVE-OBSERVATION-REPLAY'
        ...
        assert current['stage2_human_answer_synthesis_allowed'] is False
        assert current['stage3_reveal_started'] is False
        assert current['next_packet']==NATIVE_HUMAN
    else:
        ...
        assert ptr['next_packet']==STAGE2_PREP
