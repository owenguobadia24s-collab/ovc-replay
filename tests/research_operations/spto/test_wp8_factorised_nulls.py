...
def test_pointer_advances_to_diagnostics_without_real_source_authority():
    ...
    assert pointer["current_packet"] in {"C2S-SPTOI-WP8", "C2S-SPTOI-WP9", "C2S-SPTOI-WP10", "C2S-SPTOI-WP11"}
    assert pointer["next_packet"] in {"C2S-SPTOI-WP9", "C2S-SPTOI-WP10", "C2S-SPTOI-WP11", None}
