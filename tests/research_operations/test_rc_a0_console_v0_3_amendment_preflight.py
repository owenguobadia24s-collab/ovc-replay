...
class RCA0ConsoleV03AmendmentPreflightTests(unittest.TestCase):
    ...
    def test_preflight_packet_is_complete_and_review_ready(self) -> None:
    ...
    def test_exact_three_workspace_architecture_is_frozen(self) -> None:
    ...
    def test_v0_2_is_historical_and_v0_3_has_no_implementation_authority(self) -> None:
        ...
        self.assertIn("stage: RC_A0_COMPLETE_RC_A1_REVIEW_READY", registry)
        self.assertIn("shell_implementation_authority: DENIED_PENDING_RC_A1", registry)
        for token in (
