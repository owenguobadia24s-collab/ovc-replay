...
class RCWP1V03ShellNavigationTests(unittest.TestCase):
    def test_exact_three_workspace_shell_and_system_sections(self) -> None:
        ...
        self.assertEqual(SYSTEM_SECTIONS, ("HEALTH", "LINEAGE", "CATALOGUE", "RELEASES", "QA_GATES", "AUDIT", "CONFIGURATION", "ABOUT"))
    ...
    def test_fixture_pack_covers_valid_empty_warn_and_block(self) -> None:
        ...
        for mode, status in expected.items():
            ...
            self.assertEqual(bundle["summary_status"], status)
    ...
    def test_work_package_packet_is_complete_and_gate_ready(self) -> None:
        ...
        self.assertEqual(packet["baseline_commit"], "ea4d4dac2ec07845b82250980207c99e98eb581b")
        self.assertEqual(packet["acceptance_commit"], "f93a84e9bfdf36b28ba79f84da8163c3ae4e3b10")
