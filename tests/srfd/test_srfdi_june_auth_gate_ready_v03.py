...
class SRFDIJuneAuthGateReadyV03Tests(unittest.TestCase):
    ...
    def test_gate_state_stops_before_june_execution(self) -> None:
        ...
        self.assertEqual("registries/implementation/srfd/OVC_SRFDI_STATE_v0_5.json", self.pointer["authoritative_state"])
        self.assertEqual("SRFDI-G-JUNE-AUTH", self.pointer["current_gate"])
        self.assertTrue(self.pointer["operator_decision_required"])
        self.assertEqual("DENIED_PENDING_OPERATOR_SRFDI_G_JUNE_AUTH", self.pointer["june_execution"])
