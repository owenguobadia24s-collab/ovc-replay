...
class SRFDIWP10V06ExecutionBlockerTests(unittest.TestCase):
 @classmethod
 def setUpClass(cls): cls.b=json.loads(BLOCK.read_text()); cls.s=json.loads(STATE.read_text())
 ...
 def test_immutable_incident_state_is_asserted_without_current_pointer(self):
