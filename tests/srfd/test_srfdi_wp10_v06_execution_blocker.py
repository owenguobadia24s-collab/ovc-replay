...
class SRFDIWP10V06ExecutionBlockerTests(unittest.TestCase):
 ...
 def test_token_is_consumed_and_never_reusable(self):
  self.assertEqual('SRFD.JUNE.AUTH.3c63cd70ea57151a264443b436f94075bd8fb13f8a45f318a245cff96fefd168',self.b['authority_token']['token_id']); self.assertEqual('CONSUMED_NOT_REUSABLE',self.b['authority_token']['state']); self.assertTrue(self.p['authority_token_consumed']); self.assertEqual('CONSUMED_NOT_REUSABLE',self.p['authority_token_state'])
